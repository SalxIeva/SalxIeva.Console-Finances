...
// average = totalAmount / finances.length;

// You will need to track what the total change in profits is from month to month and then find the average.

// to keep a track of total changes
var totalAmount = 0;
// add variables to keep track of greatest increase/decrease followed with the month using concatenation
...
for ( var i = 1; i < finances.length; i++) {
  ...
  totalAmount += change; 
// if to find greatest increase
  if (change > greatestIncrease) {
    greatestIncrease = change;
    greatestIncreaseMonth = finances[i][0];
  }
// if to find greatest decrease 
